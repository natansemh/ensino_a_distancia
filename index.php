                ...
                <div class="pcoded-wrapper">
                    <nav class="pcoded-navbar">
                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            <?php if(!isset($_SESSION['admin']) || !$_SESSION['admin']) {?>
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.navigation">Menu Usuario</div>
                            ...
                            <div class="pcoded-navigatio-lavel" data-i18n="nav.category.forms" menu-title-theme="theme1"> Menu Administrador</div>
                            <ul class="pcoded-item pcoded-left-item">
                                <li class="">
                                    <a href="index.php">
                                        <span class="pcoded-micon"><i class="ti-home"></i><b>D</b></span>
                                ...
                                <li class="">
                                    <a href="index.php?p=relatorios">
                                        ...
                                        <span class="pcoded-mtext"  data-i18n="nav.basic-components.main">Relatorio</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
