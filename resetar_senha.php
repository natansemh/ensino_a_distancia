<?php
    ...
    if(isset($_POST['email'])) {
        ...
        if($result['id']) {
            ...
            enviarEmail($email, "SUA NOVA SENHA NA PLATAFORMA EAD", "
            <h1>Olá " . $result['nome'] . "</h1>
            <p>Uma nova senha foi redefinida para sua conta</p>
            <p><strong>NOVA SENHA</strong> " . $result['senha'] . "</p>
            ");
            $msg = "Se seu e-mail existir no banco de dados, uma senha será enviada para ele";
        } else {
            $msg = "Se seu e-mail existir no banco de dados, uma senha será enviada para ele";
        }
    }
                    ...
                    <div class="login-card card-block auth-body mr-auto ml-auto">
                        <form method="POST" class="md-float-material">
                            <div class="text-center">
                                <img height="100" src="assets/images/logo.png" alt="logo.png">
                            </div>
                            <div class="auth-box">
                                ...
                                ?>
                                <p style="color: black;">Digite seu e-mail e a senha sera enviada para ele.</p>
