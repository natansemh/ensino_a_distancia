        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <span><a href="index.php?p=cadastrar_usuarios">Clique aqui</a> para cadastrar um usuario</span>
                </div>
                                ...
                                <?php } else {
                                    ...
                                    while($usuario = $sql_query->fetch_assoc()) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="index.php?p=editar_usuarios&id=<?php echo $usuario['id'];?>">Editar</a> | <a href="index.php?p=excluir_usuarios&id=<?php echo $usuario['id'];?>">Deletar</a></td>
                                        </tr>
                                        <?php 
                                    }
                                }?>
