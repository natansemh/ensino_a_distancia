<?php
    ...
    if(isset($_POST['adquirir'])) {
        ...
        // Verificando a quantidade de creditos do cliente
        ...
        // Puxando o valor do curso
        $id_curso = intval($_POST['adquirir']);
        $sql_query_preco_curso = $mysqli->query("SELECT preco FROM cursos WHERE id = '$id_curso';") or die($mysqli->error);
        $curso = $sql_query_preco_curso->fetch_assoc();

        $preco_curso = $curso['preco'];

        if ($preco_curso > $creditos_do_usuario) {
            $erro = "Você nao possui créditos o suficiente para adquirir este curso";
        } else {
        ...
        <div class="col-lg-8">
            <div class="page-header-title">
                <div class="d-inline">
                    ...
                    <span>Adquira os nossos cursos através dos créditos de sua conta</span>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
        ...
        <div class="col-sm-4">
            <div class="card">
                ...
                <div class="card-block">
                    <img  class="img-fluid mb-3" src="<?php echo $curso['imagem']; ?>" alt="">
                    <p>
